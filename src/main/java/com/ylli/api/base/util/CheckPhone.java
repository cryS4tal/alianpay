...
public class CheckPhone {
    ...
    /**
     * 中国联通号码格式验证 手机段：130,131,132,155,156,185,186,145,175,176,1707,1708,1709
     **/
    private static final String CHINA_UNICOM_PATTERN
            = "(^1(3[0-2]|4[5]|5[56]|7[56]|8[56])\\d{8}$)|(^170[7-9]\\d{7}$)";
     ...
     */
    private static final String MULTI_PHONE_TEL_PATTERN
            = "^(?:(?:(?:(?:(?:(?:13[0-9])|(?:14[57])|(?:15[0-35-9])|(?:17[36-8])|(?:18[0-9]))\\d{8})"
            + "|(?:170[057-9]\\d{7})|(?:\\(\\d{3,4}\\)|\\d{3,4}-)?\\d{7,8}(?:-\\d{1,4})?)[,\\s、])+)?"
            + "(?:(?:(?:(?:13[0-9])|(?:14[57])|(?:15[0-35-9])|(?:17[36-8])|(?:18[0-9]))\\d{8})"
            + "|(?:170[057-9]\\d{7})|(?:\\(\\d{3,4}\\)|\\d{3,4}-)?\\d{7,8}(?:-\\d{1,4})?)$";

    private static final String SIMPLE_PHONE_PATTERN = "^1(3|4|5|7|8|9)[0-9]\\d{8}$";
    ...
    public static boolean isSimplePhone(String input) {
        return match(SIMPLE_PHONE_PATTERN, input);
    }
    ...
    private static boolean match(String regex, String input) {
        return !Strings.isNullOrEmpty(input) && Pattern.matches(regex, input);
    }
}
